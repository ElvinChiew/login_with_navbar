defmodule BbWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {BbWeb.Layouts, :root}
  ...
  scope "/", BbWeb do
    ...
    live "/item_stocks/:id", ItemStockLive.Show, :show
    live "/item_stocks/:id/show/edit", ItemStockLive.Show, :edit
  end
  ...
  if Application.compile_env(:bb, :dev_routes) do
  ...
  scope "/", BbWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BbWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BbWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BbWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BbWeb do
    ...
    live_session :current_user,
      on_mount: [{BbWeb.UserAuth, :mount_current_user}] do
